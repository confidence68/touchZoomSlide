(function(a, c) {
  a.extend(a.fn, {
      prefix: function(d) {
          a.each(d, function(f, e) {
              var g = '{"-webkit-' + f + '":"' + e + '","-moz-' + f + '":"' + e + '","-ms-' + f + '":"' + e + '","-o-' + f + '":"' + e + '"}';
              a.extend(d, a.parseJSON(g));
          });
          a(this).css(d);
      },
      swipe: function(g) {
          ...
          a.extend(h, g);
          if (typeof h.start === "function" && typeof h.move === "function" && typeof h.end === "function") {
              a(this).on("touchstart.swipe", function(i) {
                  a.extend(f, {
                      x: i.originalEvent.touches[0].pageX,
                      y: i.originalEvent.touches[0].pageY
                  });
                  h.start.apply(this, arguments);
              });
              a(this).on("touchmove.swipe", function(i) {
              ...
              a(this).on("touchend.swipe", function(i) {
                  if (d) {
                      d = false;
                      h.end.call(this, i, {
                          x: e.x - f.x,
  ...
  a.event.special.tap = {
      setup: function() {
          a(this).off("click").on(b.start + " " + b.end, function(d) {
              b.e = d.originalEvent.changedTouches ? d.originalEvent.changedTouches[0] : d;
          }).on(b.start, function(d) {
              ...
              if (b.target === d.target && ((new Date().getTime() - b.time) < 750) && (Math.sqrt(Math.pow(b.X - b.e.pageX, 2) + Math.pow(b.Y - b.e.pageY, 2)) < 15)) {
                  d.type = "tap";
                  d.pageX = b.e.pageX;
                  d.pageY = b.e.pageY;
                  a.event.dispatch.call(this, d);
              }
          });
      },
      teardown: function() {
          a(this).off(b.start + " " + b.end);
      }
  };
  a.fn["tap"] = function(d) {
      return this[d ? "on" : "trigger"]("tap", d);
  }
  ;
}(jQuery));
